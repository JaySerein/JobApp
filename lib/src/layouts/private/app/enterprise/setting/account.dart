...
import 'package:job_app/src/layouts/private/app/enterprise/setting/widgets/account_form.dart';
import 'package:job_app/src/layouts/private/app/enterprise/setting/widgets/account_info.dart';
import 'package:job_app/src/utils/helpers/device_func.dart';

class EnterpriseAccount extends StatelessWidget {
  EnterpriseAccount({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              EAccountInfo(user: user.currentUser),
            ],
          ),
        ),
      ),
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
          ...
          SizedBox(
              ...
              child: ElevatedButton(
                  onPressed: () {
                    Get.to(() => const EnterpriseAccountUpdate());
                  },
