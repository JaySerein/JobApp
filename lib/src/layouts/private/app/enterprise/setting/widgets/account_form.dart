...
import 'package:job_app/src/controllers/enterprise/enterprise_account_update_controller.dart';
...
class EnterpriseAccountUpdate extends StatelessWidget {
  const EnterpriseAccountUpdate({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EnterpriseAccountUpdateController());
