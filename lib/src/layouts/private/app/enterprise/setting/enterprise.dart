...
import 'package:job_app/src/layouts/private/app/enterprise/setting/account.dart';
...
class EnterpriseSettingScreen extends StatelessWidget {
  const EnterpriseSettingScreen({super.key});
          ...
          children: [
            ...
            JHeaderContainer(
              ...
              children: [
                ...
                //profile card
                GestureDetector(
                  onTap: () => Get.to(() => EnterpriseAccount()),
                  child: JProfileTitle(
              ...
              child: Column(
                children: [
                  ...
                  JProfileMenuTitle(
                      ...
                      onTap: () => Get.to(() => const EnterpriseProfile())),
                  JProfileMenuTitle(
                      icon: Iconsax.clock,
