...
class JobInviteDetailScreen extends StatelessWidget {
  const JobInviteDetailScreen({super.key});
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
          SizedBox(
              ...
              child: OutlinedButton(
                  onPressed: () {}, child: const Text('Từ chối'))),
          SizedBox(
              width:
                  JDevice.getScreenWidth(context) / 2 - JSizes.spaceBtwSections,
              child: ElevatedButton(
                  onPressed: () {}, child: const Text("Chấp nhận"))),
        ]),
      ),
    );
  }
